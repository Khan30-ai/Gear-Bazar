...
export default function AdminLayout() {
    ...
    const navItems = [
        ...
        { name: 'Seller Approvals', path: '/admin/sellers', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
        ...
        <div className="min-h-screen bg-slate-50 flex">
            ...
            <aside className="w-64 bg-slate-950 text-slate-300 hidden md:flex flex-col">
                <div className="h-16 flex items-center px-6 bg-slate-900">
                    <span className="text-xl font-bold text-white tracking-tight">Admin<span className="text-orange-500">Panel</span></span>
                </div>
            ...
            <main className="flex-1 flex flex-col min-w-0">
                <header className="h-16 bg-white border-b border-slate-200 flex items-center px-6 lg:px-8 shadow-sm justify-between">
                    <div className="md:hidden font-bold text-lg text-slate-900">AdminPanel</div>
