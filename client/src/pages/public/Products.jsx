    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                console.warn('API connection failed. Falling back to high-fidelity mock B2B catalog.', err);
                const standardizedFallback = PRODUCTS.map(p => ({
                    ...p,
                    _id: String(p._id || p.id)
                }));
                setProducts(standardizedFallback);
            } finally {
                setLoading(false);
            }
        };
                                                    ...
                                                    <div className="border-t border-slate-100 pt-3 mt-auto">
                                                        ...
                                                        <div className="flex items-center gap-1 mb-2.5">
                                                            <div className="flex items-center text-amber-500">
                                                                ...
                                                                <span className="text-[11px] font-bold text-slate-800 ml-0.5">{product.rating.toFixed(1)}</span>
                                                            </div>
                                                        ...
                                                        <div className="flex gap-1.5">
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex-1 bg-slate-950 text-white hover:bg-orange-600 hover:text-white disabled:bg-slate-200 disabled:text-slate-400 text-[11px] font-bold py-2 px-2.5 rounded-sm transition-all duration-200 flex items-center justify-center gap-1 cursor-pointer"
                                                            >
